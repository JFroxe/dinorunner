...
}{gdjs.evtTools.sound.playMusic(runtimeScene, "Soundtrack.mp3", true, 50, 1);
}}
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDDinoObjects5.length;i<l;++i) {
    if ( gdjs.GameCode.GDDinoObjects5[i].hasAnimationEndedLegacy() ) {
        isConditionTrue_0 = true;
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(8743636);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(8748164);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDDinoObjects5 */
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(8749316);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(8751444);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(8752076);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(8746772);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("DustParticles"), gdjs.GameCode.GDDustParticlesObjects4);
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "Bumble", false, 100, 0.5);
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDDinoObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDDinoObjects1[i].hasAnimationEndedLegacy() ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDDinoObjects1[k] = gdjs.GameCode.GDDinoObjects1[i];
        ++k;
    }
